  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				<div class="card" style="width: 14rem; float:left; margin-left:5px">
				  <img src="http://localhost/jsp_prj/common/images/${ pDTO.img }" class="card-img-top" alt="...">
				  <div class="card-body">
				    <h5 class="card-title"> Card title <c:out value="${ pDTO.title }"/></h5>
				    <p class="card-text"><c:out value="${ pDTO.info }"/>
				    <br>
				    제조일 : <fmt:formatDate value="${ pDTO.prdDate }" pattern="yyyy-MM-dd HH:mm"/>
				    <a href="#" class="btn btn-primary"><fmt:formatNumber value="${pDTO.price}" pattern="#,###"></fmt:formatNumber></a> 원
				  </div>
				</div>
				</c:forEach>								
