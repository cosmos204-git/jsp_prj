			...
			<div class="row featurette">
				<div class="col-md-7">
					...
					<!-- enctype="application/x-www-form-urlencoded"  파라메터 전송방식 > 
					     enctype="multipart/form-data"  파일전송 방식, binary 전송 방식 -->
					...
					<br>
					<label>파일</label>
					<img src="http://localhost/jsp_prj/common/images/default_img.png" id="preview" 
					style="width: 100px:height:100px; border:radius:50px"/>
					
					<input type="button" value="파일선택" name="파일선택" class="btn btn-success btn-sm" id="btnFile" /><br>
					업로드는 이미지(jpg, gif, png, bmp)만 가능합니다.
					<div id="selectFile"></div>
					
					<!-- 아래는 이미지의 모든 확장자만 보여줘 가 된다. <input type="file" accept=".jpg, .gif, .png, .bmp" name="upfile" id="upfile" style="display:none"/><br>  -->
