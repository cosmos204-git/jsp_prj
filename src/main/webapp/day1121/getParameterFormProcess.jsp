...
<body>
	...
	//입력한 값을 유효성검증 (back-end) >서비스객체 > DAO > 리턴값을 서비스가 받아서 
	// > jsp로 리턴 > jsp는 리턴된 값을 받아서 이쁘게 만들어서 사용자에게 응답함.
	%>
	<div>
	<strong><%= request.getMethod() %>Get 방식으로 처리한 입력값</strong>
	<ul>
	<!--  String 클래스를 생성하여 한글 변환가능하기는 하지만 잘 사용하지 않는다. -->
