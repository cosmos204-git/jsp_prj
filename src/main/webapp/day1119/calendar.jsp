...
/* 선택자를 구체적으로 변경하고, 이중 테두리 방지를 위해 collapse 추가 */ 
#calTab { border-collapse: collapse; }
#calTab th, #calTab td { border:1px solid #C7C8C9; }
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div>
               ...
               //if를 타면 설정된 sus이 저장되고, if를 타지 않으면 현재 년이 저장된다.
               nowYear=cal.get(Calendar.YEAR);
               
               //입력된 월 받기
			   String paramMonth=request.getParameter("paramMonth");
               if ( paramMonth !=null ) { // web parameter가 존재하면
            	   //Calendar 객체의 월을 0~11월, 12달을 사용 ( 사람의 월보다 1적다 )
            	   //10월이 입력되면 자바는 11월 
               ...
               %>
               <div id="calHeader">
                <a href="calendar.jsp?paramYear=<%= nowMonth-1==0? nowYear-1:nowYear %>&paramMonth=<%= nowMonth -1==0 ? 12 : nowMonth-1 %>"><span class="calTitle"></span>
               	<span>&lt;</span></a>
               	<span class="calTitle"><%=nowYear%>-<%=nowMonth%></span>
                <a href="calendar.jsp?paramYear=<%= nowMonth+1==13? nowYear+1:nowYear %>&paramMonth=<%= nowMonth +1==13 ? 1 : nowMonth+1 %>"><span class="calTitle"></span>
               	<span>&gt;</span></a>
			   ...
			   for(int tempDay=1; ;tempDay++){ //마지막 날을 모름
					...
					//현재 월에 없는 날짜가 입력되면 자동으로 다음 달 1일이 된다.
