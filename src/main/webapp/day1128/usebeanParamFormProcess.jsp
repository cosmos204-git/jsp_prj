  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				<!-- web parameter가 아닌 접속자의 정보를 받아야 함 -->
				<%
				...
				***********************************************/
				...
				//한정적인 자원을 동시 사용할 때 조회를 먼저 수행한 후 다음 작업으로 진행한다.
				boolean idFlag=wms.searchId(pDTO.getId());
				
				if(!idFlag) { //다른 사용자가 아이디를 선점한 경우
				%>
				입력하신 ${ param.id }는 이미 사용 중입니다. <br>
				다른 아이디를 입력해 보세요. <a href="javascript:history.back()" class="btn btn-success">뒤로</a>	
				<%	
				}else{
				...
				<div>
				<strong>&lt;jsp:getProperty 사용</strong>
				배열의 주소가 출력 : <jsp:getProperty property="language" name="pDTO"/>
				...
				<a href="${ CommonURL }/index.html">첫 화면으로</a>
				</c:when>
				<c:otherwise>
				<img src="../common/images/fail.png"/><br>
				${ param.name }님 회원 가입 실패하였습니다.<br>
				잠시 후 다시 시도해 주세요.<br>
