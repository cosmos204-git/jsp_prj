	...
	$.ajax({
		...
		success:function( jsonObj ) {
             ...
             $.each(jsonArr, function( ind, jsonTemp ){
            	 createTr="<tr><td>"+(ind+1)+"</td><td><a href='javascipt:empDetail("+
					jsonTemp.empno+")'>" + jsonTemp.ename+"</a></td><td>"+
					jsonTemp.job+"</dt><td>" + jsonTemp.sal+"</td><td>"+
					jsonTemp.hiredate+"</dt><td>"+
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				%>
					...
					<input type="button" value="검색" class="btn btn-success btin-sm" id="btn"/>
					</div>
				</div>
				
				<div id="output">
				<div>조회일자 : <span id="pubDate"></span> /사원수 [<span id="empCnt">0</span>]
