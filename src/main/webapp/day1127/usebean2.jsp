  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<%-- 
				...
				%>
				session : 당신은 이페이지의 <%= cnt.getCnt() %>번째 방문자입니다.
				<%
				}//endif
				%>
		    --%>
				...
				%>
				<img src="http://192.168.10.79/jsp_prj/common/images/num/num_<%= cnt.charAt(i) %>.png">
				<%	
				} // end for 
				%>
				...
				%>
				application : 당신은 이페이지의 <%= cnt.getCnt() %>번째 방문자입니다.
				<%
				}//endif
				%>
